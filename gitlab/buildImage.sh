...
#   Official release:   ./buildImage.sh "official" "git" "" "false" "latest" "" "official"
#   Alpine release:     ./buildImage.sh "alpine" "git" "" "false" "" "" "alpine"
#   Debian release:     ./buildImage.sh "debian" "git" "" "false" "" "" "debian"
...
for tag in "${tags[@]}"; do
    ...
    if [ "${BUILT_TAG}" = "" ]; then
        ...
        BUILT_TAG=${tag}
        echo "- Build image $CI_REGISTRY_IMAGE:${BUILT_TAG} ..."
